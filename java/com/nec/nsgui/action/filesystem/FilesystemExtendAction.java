...
public class FilesystemExtendAction extends  Action {
    private static final String cvsid = "@(#) $Id: FilesystemExtendAction.java,v 1.2 2005/11/18 01:29:16 jiangfx Exp $Exp $";
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        String ldList     = (String)((DynaValidatorForm)form).get("ldList"); 

        int nodeNo = NSActionUtil.getCurrentNodeNo(request);
        FilesystemHandler.extendFS(fsInfo, ldList, nodeNo);
