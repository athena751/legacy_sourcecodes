 ...
 * For forward
 */
public class ModuleForwardAction extends Action implements FrameworkConst {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        try {
            String selectExpgrp = (String) request.getParameter("selectExpgrp");
            if ( (selectExpgrp != null) && selectExpgrp.equals("enable")) {
        ...
        return mapping.findForward("moduleForward");
    }
}