...
public class NSReporter {
	private static final String	cvsid = "@(#) $Id: NSReporter.java,v 1.2302 2007/04/26 05:56:25 liul Exp $";
	...
	public void	report(Category tempcat, int level, String message) {
		tempcat.log(Level.toLevel(level), NSMessageDriver.getInstance().reformMessage(message,"en"));
	}
	public void	report(int level, String message) {
		...
		cat.log(Level.toLevel(level), NSMessageDriver.getInstance().reformMessage(msg,"en"));
	}
