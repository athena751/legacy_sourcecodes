...
# "@(#) $Id: quota_changequota.pl,v 1.2301 2006/02/20 00:34:41 zhangjun Exp $"
...
if (system("$command1 $command2 $command3 \Q$filesystem\E")!=0)
{
    print STDERR "Failed to execute \"$command1 $command2 $command3 $filesystem\". Exit in perl script:",__FILE__," line:",__LINE__+1,".\n";
    exit(1);
}
exit(0);