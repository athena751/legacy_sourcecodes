...
<!-- "@(#) $Id: diruserreport.jsp,v 1.2305 2006/12/08 02:42:25 zhangjun Exp $" -->
...
function onIDSort()
{
    window.location = "diruserreport.jsp?keyword=id&reverse=<%=byid%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteUsedSort()
{
    window.location = "diruserreport.jsp?keyword=bused&reverse=<%=bybused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteSoftSort()
{
    window.location = "diruserreport.jsp?keyword=bsoft&reverse=<%=bybsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteHardSort()
{
    window.location = "diruserreport.jsp?keyword=bhard&reverse=<%=bybhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteGraceSort()
{
    window.location = "diruserreport.jsp?keyword=bgrace&reverse=<%=bybgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}

function onFileUsedSort()
{
    window.location = "diruserreport.jsp?keyword=fused&reverse=<%=byfused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileSoftSort()
{
    window.location = "diruserreport.jsp?keyword=fsoft&reverse=<%=byfsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileHardSort()
{
    window.location = "diruserreport.jsp?keyword=fhard&reverse=<%=byfhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileGraceSort()
{
    window.location = "diruserreport.jsp?keyword=fgrace&reverse=<%=byfgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
</script>
</head>
...
<h2 class="title"><nsgui:message key="nas_quota/quotasettop/href_1_dir"/></h2>
