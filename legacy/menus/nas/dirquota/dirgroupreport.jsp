...
<!-- "@(#) $Id: dirgroupreport.jsp,v 1.2305 2006/12/08 02:42:25 zhangjun Exp $" -->
...
function onIDSort()
{
    window.location = "dirgroupreport.jsp?keyword=id&reverse=<%=byid%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteUsedSort()
{
    window.location = "dirgroupreport.jsp?keyword=bused&reverse=<%=bybused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteSoftSort()
{
    window.location = "dirgroupreport.jsp?keyword=bsoft&reverse=<%=bybsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteHardSort()
{
    window.location = "dirgroupreport.jsp?keyword=bhard&reverse=<%=bybhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onByteGraceSort()
{
    window.location = "dirgroupreport.jsp?keyword=bgrace&reverse=<%=bybgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}

function onFileUsedSort()
{
    window.location = "dirgroupreport.jsp?keyword=fused&reverse=<%=byfused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileSoftSort()
{
    window.location = "dirgroupreport.jsp?keyword=fsoft&reverse=<%=byfsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileHardSort()
{
    window.location = "dirgroupreport.jsp?keyword=fhard&reverse=<%=byfhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
function onFileGraceSort()
{
    window.location = "dirgroupreport.jsp?keyword=fgrace&reverse=<%=byfgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>"+"&DirQuota=yes";
}
</script>
...
<h2 class="title"><nsgui:message key="nas_quota/quotasettop/href_2_dir"/></h2>
  ...
  <table width="100%" border="1">
    ...
    <tr>
      <td ><%=template.getID()%></td>
        <%//Long BlockSoftLimit = new Long(template.getBlockSoftLimit());
          //Long BlockHardLimit = new Long(template.getBlockHardLimit());
...
<br>
  ...
  <p></p>
    ...
    <input type="hidden" name="pageFlag" value="group">
</form>
</body>
</html>
