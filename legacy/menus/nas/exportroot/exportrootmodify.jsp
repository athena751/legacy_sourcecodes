...
<!-- "@(#) $Id: exportrootmodify.jsp,v 1.7 2006/05/16 01:15:53 liq Exp $" -->
...
<script language="JavaScript">
    ...
    function onChgDomain(){
        window.location = "<%=response.encodeURL("../mapd/userdbdomainconf.jsp?exportGroup=/export/"
    ...
    function reloadPage(){
        ...
        setSubmitted();         
        window.location="<%= response.encodeURL("exportrootmodify.jsp?exportgroup=" + exportGroupName + "&codepage=" + codePage) %>";
    }
</script>
</HEAD>
...
<form  method="post" name="modifyForm" action="">
    ...
    <h2 class="title"><nsgui:message key="nas_exportroot/exportroot/h2_modify"/></h2> 
    <table border="1">
        <tr>
    ...
    <%if (notdispdbinfo_U && notdispdbinfo_W){%>
    <br>
        <table border="0">
            <tr>
            <td><nsgui:message key="nas_exportroot/exportroot/domain_notset"/><br>
            <nsgui:message key="nas_exportroot/exportroot/domain_notes"/></td>
            </tr>
        </table>
        <p>
    ...
    <p>
    <input type="button" name="btnModify" value="<nsgui:message key="nas_mapd/button/chg_dom"/>" onclick="return onChgDomain();">
    </p>
    <%}%>
