...
<!-- "@(#) $Id: groupreport.jsp,v 1.2303 2005/09/08 08:34:19 cuihw Exp $" -->
...
function onIDSort()
{
    window.location = "groupreport.jsp?keyword=id&reverse=<%=byid%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onByteUsedSort()
{
    window.location = "groupreport.jsp?keyword=bused&reverse=<%=bybused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onByteSoftSort()
{
    window.location = "groupreport.jsp?keyword=bsoft&reverse=<%=bybsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onByteHardSort()
{
    window.location = "groupreport.jsp?keyword=bhard&reverse=<%=bybhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onByteGraceSort()
{
    window.location = "groupreport.jsp?keyword=bgrace&reverse=<%=bybgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}

function onFileUsedSort()
{
    window.location = "groupreport.jsp?keyword=fused&reverse=<%=byfused%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onFileSoftSort()
{
    window.location = "groupreport.jsp?keyword=fsoft&reverse=<%=byfsoft%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onFileHardSort()
{
    window.location = "groupreport.jsp?keyword=fhard&reverse=<%=byfhard%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
function onFileGraceSort()
{
    window.location = "groupreport.jsp?keyword=fgrace&reverse=<%=byfgrace%>&commandid=<%=commandid%>&type=<%=type%>&displayControl="+displayControl+"&unit=<%=unit%>";
}
</script>
...
<h2 class="title"><nsgui:message key="nas_quota/userreport/td_groupstatus"/></h2>
