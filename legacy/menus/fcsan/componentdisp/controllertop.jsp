...
<!-- "@(#) $Id: controllertop.jsp,v 1.2301 2005/09/21 04:53:50 wangli Exp $" -->
...
<head>
    ...
    <script language="JavaScript">
        ...
        function onRefresh(){  
            parent.middleframe.location="<%=response.encodeURL("controllerlistrefresh.jsp")%>?diskArrayID=<%=diskArrayID%>&diskname=<%=diskname%>" 
        }
    </script>    
</head>
<body>
...
<h2 class="title"><nsgui:message key="fcsan_componentdisp/controller/h2"/></h2>
</form>
</body>
</html>
