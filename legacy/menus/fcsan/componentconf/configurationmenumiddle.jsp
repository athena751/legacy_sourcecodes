...
<!-- "@(#) $Id: configurationmenumiddle.jsp,v 1.2309 2005/09/21 04:49:10 wangli Exp $" -->
...
<script language=javascript>
    ...
    function loadFrame() {    
        parent.topframe.location="<%=response.encodeURL("configurationmenutop.jsp")%>" ;
        parent.bottomframe.location="<%= response.encodeURL("configurationmenubottom.jsp")%>";
