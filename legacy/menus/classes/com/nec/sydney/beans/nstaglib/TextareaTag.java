...
public class TextareaTag extends BaseTag {
    ...
    private static final String cvsid = "@(#) $Id: TextareaTag.java,v 1.2300 2003/11/24 00:54:53 nsadmin Exp $";
    ...
    /**
     * Change "onfocus" to disabled the textarea
     * If the textarea is in readonly mode, (on NN4.76 only),
