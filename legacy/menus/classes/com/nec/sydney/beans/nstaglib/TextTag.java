...
public class TextTag extends BaseTag {
    ...
    private static final String cvsid = "@(#) $Id: TextTag.java,v 1.2300 2003/11/24 00:54:53 nsadmin Exp $";
    ...
    /**
     * Change "onfocus" to disabled the text
     * If the text is in readonly mode, (on NN4.76 only),
