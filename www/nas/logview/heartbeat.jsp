...
<!-- "@(#) $Id: heartbeat.jsp,v 1.4 2008/05/09 05:07:18 hetao Exp $" -->
...
<bean:define id="startTime" name="nfslog_perform_startTime" type="java.lang.String"/>
...
function colseLogViewWin(){
    window.parent.opener.colseLogViewWin();
}

</script>
</head>
<body onload="pageLoad();">
<html:form action="heartbeat.do?operation=cancelSearch" method="post" onsubmit="colseLogViewWin();" >
...
<b><bean:message key="nfs.perfomrLog.heartbeat.msg.usedTimeInfo"/></b>
<br><br>
<div align="center"> 
<input type="submit" name="button_cancelSearch"
 value="<bean:message key="nfs.perfomrLog.heartbeat.button.cancel"/>" />
</div>
</html:form>
</body>
</html>
...
function pageLoad(){
    <logic:equal name="<%=SyslogActionConst.SESSION_NAME_NFS_PERFORM_SEARCH_ENDED%>"
     value="<%=SyslogActionConst.NFS_PERFORM_SEARCH_ENDED%>">
        top.close();
    </logic:equal>
