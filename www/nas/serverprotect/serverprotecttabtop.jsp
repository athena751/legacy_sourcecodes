...
<!-- "@(#) $Id: serverprotecttabtop.jsp,v 1.4 2007/03/23 09:43:18 liul Exp $" -->
...
<nstab:nstab divoptions="style=\"top:78px;\"" >
    ...
    <nstab:subtab url="serverProtectDisplayScanServer.do">
        <bean:message key="serverprotect.tab.scanserver"/>
    </nstab:subtab>
    <nstab:subtab url="serverProtectDisplayScanShare.do">
        <bean:message key="serverprotect.tab.scanshare"/>
    </nstab:subtab>
    <nstab:subtab url="serverProtectDirectEdit.do">
