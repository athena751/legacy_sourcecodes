...
<!-- "@(#) $Id: nfslisttop4nsview.jsp,v 1.2 2007/05/09 06:08:46 caows Exp $" -->
...
function reloadPage(){
    ...
    setSubmitted();
    window.location="<html:rewrite page='/nfsListTop4nsview.do?operation=display'/>";
}

</script>
<html:base/>
</head>
<body onload="init();setHelpAnchor('network_nfs_1');">
