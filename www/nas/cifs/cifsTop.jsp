...
<!-- "@(#) $Id: cifsTop.jsp,v 1.9 2007/05/09 06:04:12 chenbc Exp $" -->
...
<nstab:subtab url="enterCifs.do"><bean:message key="cifs.tab.share"/></nstab:subtab>
<nstab:subtab url="loadGlobalFrame.do"><bean:message key="cifs.tab.global"/></nstab:subtab>
<logic:equal name="<%=CifsActionConst.SESSION_SECURITY_MODE%>" value="<%=CifsActionConst.SECURITYMODE_ADS%>" scope="session">
    <nstab:subtab url="specialShare.do"><bean:message key="cifs.tab.specialShare"/></nstab:subtab>
...
<nstab:subtab url="directEdit.do?operation=displayForSmbConf"><bean:message key="cifs.tab.smbConf"/></nstab:subtab>
<nstab:subtab url="directEdit.do?operation=displayForDirAccessConf"><bean:message key="cifs.tab.dirAccessConf"/></nstab:subtab>
<nstab:subtab url="loadOtherOptions.do"><bean:message key="cifs.otherOptions.tab"/></nstab:subtab>
</nstab:nstab>
</body>
</html>
