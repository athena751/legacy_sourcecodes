...
<!-- "@(#) $Id: cifsglobaloptionbottom.jsp,v 1.2 2005/06/20 04:40:44 changhs Exp $" -->
...
function onSubmit(){
  if(window.parent.frames[0] &&  window.parent.frames[0].document.forms[0]&& window.parent.frames[0].document.forms[0].encpasswd){
...
<form method="POST" name="globalBottomForm">
