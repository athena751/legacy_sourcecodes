...
<!-- "@(#) $Id: fsmovenavigatorlist.jsp,v 1.3 2007/05/09 08:18:49 xingyh Exp $" -->
...
<html:form action="moveFSNavigator.do?operation=list">

<bean:size id="dirSize" name="fsMoveAllDirectoryInfo"/>


<bean:define id="nowDirTrue" name="moveFSNavigatorForm" property="nowDirectory"/>
<bean:define id="rootDir" name="moveFSNavigatorForm" property="rootDirectory"/>

<logic:equal name="dirSize" value="0">
	<logic:equal name="moveFSNavigatorForm" property="rootDirectory" value="<%=(String)nowDirTrue%>">
		<bean:message key="msg.navigator.noExportGroup"/>
	</logic:equal>
	
	<logic:notEqual name="moveFSNavigatorForm" property="rootDirectory" value="<%=(String)nowDirTrue%>">
		<table>
		<tr>
...
<logic:notEqual name="dirSize" value="0">	
	<table>
		...
		<logic:iterate id="oneDir" name="fsMoveAllDirectoryInfo">
