...
<!-- "@(#) $Id: nswsamplingnstab4nsview.jsp,v 1.1 2005/10/19 05:08:17 zhangj Exp $" -->
...
<%  String vp=CollectionConst3.STATIS_NFS_VIRTUAL_PATH;
    ...
    String virtualpathStr="nswsampling4nsview.do?operation=tabSwitch&colItemID="+vp;
    String serverStr="nswsampling4nsview.do?operation=tabSwitch&colItemID="+server;
    String nodeStr="nswsampling4nsview.do?operation=tabSwitch&colItemID="+node;  %>
<body>
    <div class="h1">
