...
<!-- "@(#) $Id: nasswitchgraphtop.jsp,v 1.2 2005/10/24 12:28:16 pangqr Exp $" -->
...
<h1 id="title">
  ...
  <nstab:nstab displayonload="<%=displayonload%>">
    <nstab:subtab url="forwardToBottom.do?graphType=Daily"><bean:message key="RRDGraph.button_daily"/></nstab:subtab> 
		<nstab:subtab url="forwardToBottom.do?graphType=Weekly"><bean:message key="RRDGraph.button_weekly"/></nstab:subtab>            
		<nstab:subtab url="forwardToBottom.do?graphType=Monthly"><bean:message key="RRDGraph.button_monthly"/></nstab:subtab>           
		<nstab:subtab url="forwardToBottom.do?graphType=Yearly"><bean:message key="RRDGraph.button_yearly"/></nstab:subtab>        
        <nstab:subtab url="forwardToBottom.do?graphType=User Specification"><bean:message key="RRDGraph.button_custom"/></nstab:subtab>
